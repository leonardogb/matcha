  ...
  var readURL = function (input, nbImg) {
    if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
        if (nbImg == "img0") $(".img0").attr("src", e.target.result);
        else if (nbImg == "img1") $(".img1").attr("src", e.target.result);
        else if (nbImg == "img2") $(".img2").attr("src", e.target.result);
        else if (nbImg == "img3") $(".img3").attr("src", e.target.result);
        else if (nbImg == "img4") $(".img4").attr("src", e.target.result);
      };
